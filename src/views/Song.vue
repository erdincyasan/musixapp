      ...
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        <div class="px-6 pt-6 pb-5 font-bold border-b border-gray-200">
          ...
          <span class="card-title">
            {{
              $tc('song.comment_count', song.commment_count, { count: song.comment_count })
            }}</span
          >
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: 'Please wait! you are comment is being submitted =)',
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Please wait! you are comment is being submitted';
  ...
  async beforeRouteEnter(to, from, next) {
    ...
    // TODO docSnapshot.exist is not working correctly!
